...
`src/main/java/app/HelloController.java`
[source,java]
----
include::initial/src/main/java/app/HelloController.java[]
----
...
`src/test/java/app/HelloControllerTest.java`
[source,java]
----
include::complete/src/test/java/app/HelloControllerTest.java[]
----
...
`src/test/java/app/HelloControllerIT.java`
[source,java]
----
include::complete/src/test/java/app/HelloControllerIT.java[]
----
